...
ActiveRecord::Schema.define(version: 20_200_622_052_326) do
  ...
  create_table 'rerationships', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[follower_id followed_id], name: 'index_rerationships_on_follower_id_and_followed_id', unique: true
  end
